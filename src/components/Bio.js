...
function Bio() {
  return (
    <section className="bio fade-in-element" id="about">
      ...
      <p>
        Catering to businesspeople and affluent clients, Anjali brings her artistic vision and professional expertise 
        to every event, creating flawless looks that enhance natural beauty and leave lasting impressions.
      </p>
    </section>
  );
}
